...
class CustomDropDownmButtonTipoServicoWidget extends GetView {
  final AddServicoController controller = Get.find<AddServicoController>();
  final List<CategoriaServicos> servicos;

  CustomDropDownmButtonTipoServicoWidget({ this.servicos});
  ...
  Widget build(BuildContext context) {
    return controller.servicos != null ? Container(
      ...
      value: null,
      hint: Text("Selecione um tipo de Serviço", style: TextStyle(fontSize: 20.0),),
